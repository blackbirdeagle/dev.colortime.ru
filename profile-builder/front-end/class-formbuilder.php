	...
	function wppb_output_form_fields( $global_request, $field_check_errors, $form_fields, $called_from = NULL ){
		...
		if( !empty( $form_fields ) ){
			...
			foreach( $form_fields as $field ){
				...
				$output_fields .= apply_filters( 'wppb_output_before_form_field', '<div class = "business__form__field" id="wppb-form-element-'. $field['id'] .'">', $field, $error_var, $this->args['role'] );
